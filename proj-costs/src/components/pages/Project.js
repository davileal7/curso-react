import {parse, v4 as uuidv4} from 'uuid' //instalado no inicio//

import styles from './Project.module.css'

import { useParams } from 'react-router-dom' //pegar Id pela URL//
...
function Project() {
    ...
    function editPost(project) {
        ...
        fetch(`http://localhost:5000/projects/${id}`, {
                    method:"PATCH",         //altera só o que foi mudado
                    headers: {              //comunica com Json só com a API
                'Content-Type':'application/json',
            },
            body: JSON.stringify(project),  //enviar projeto como texto  
        })
        .then(resp => resp.json())
        .then((data) => {
